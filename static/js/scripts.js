...
// Preloader
		if($(".contact-1").length <= 0 && $(".contact-2").length <= 0 && $(".loader").length > 0) {
			...
			var bg_color = $(".loader").attr('data-background-color') || '#000000',
				text_color = $(".loader").attr('data-text-color') || '#ffffff';

			$(".loader").before('<style id="cosy-custom-styler" type="text/css">.loader .circle{border: 2px solid '+text_color+';border-right-color: transparent;}</style>');
			$("#cosy-custom-styler").append('.loader p{color: '+text_color+';}.loader{background-color: '+bg_color+';}');
